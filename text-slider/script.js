...
var slidesJS_config = {
	...
	slider: {
		...
		animationStart: function(current) {
			$('.slidesJS-caption', '.' + this.container).slideUp(200);
		},
...
(function($, w, d) {
	...
	s.src = sc.url.replace(/\/$/, "") + '/feeds/posts/summary' + (sc.labelName  ? '/-/' + sc.labelName : "") + '?alt=json-in-script&orderby=published&max-results=' + sc.numPost + '&callback=blogger_slidesJS';
	head.appendChild(s);
